...
const BOT_RESPONSES: { keywords: string[]; reply: string }[] = [
  ...
  { keywords: ["monitor", "monitoring", "24/7", "dispatch", "local"],
    reply: "Our monitoring center is based right here in Houston — not outsourced to a national call center. When an alarm triggers, local operators dispatch local authorities immediately." },
  { keywords: ["area", "serve", "location", "houston", "katy", "sugar land", "woodlands"],
    reply: "We serve the entire Greater Houston metro: Houston, Katy, Sugar Land, The Woodlands, Cypress, Pearland, League City, and all surrounding communities." },
  { keywords: ["contract", "long-term", "locked in"],
    reply: "No long-term contracts — ever. We earn your business month to month. Your account also stays with our local team permanently; we never sell it to a third party." },
