...
const BOT_RESPONSES: { keywords: string[]; reply: string }[] = [
  ...
  { keywords: ["camera", "surveillance", "4k", "lpr", "license plate"],
    reply: "We install 4K IP cameras, license plate reader systems, and custom security poles for commercial properties, HOAs, and residential estates across Greater Houston." },
  { keywords: ["hoa", "community", "gate", "property management", "apartment"],
    reply: "HOA and property management security is our specialty — gate cameras, License Plate Reader (LPR), common area surveillance, and active deterrence. We'd love to walk your property." },
