...
const COMPANY = {
  ...
  areaServed: [
    "Houston", "River Oaks", "Bellaire", "West University Place",
    "Hunters Creek Village", "Piney Point Village", "Bunker Hill Village",
    "Hedwig Village", "Hilshire Village", "Spring Valley Village",
    "Galleria Area", "Tanglewood", "Energy Corridor", "Memorial",
    "Upper Kirby", "Rice Military", "Montrose", "Afton Oaks",
    "Medical Center Area", "Downtown Houston", "Southside Place",
  ],
...
const HOUSTON_SECURITY_SEARCH_PHRASES = [
  ...
  "home security company Houston",
  "best home security Houston",
  ...
  "alarm companies near me Houston",
  ...
  "HOA security camera company near me",
  "gate camera installation near me",
  "24 hour alarm monitoring near me",
  "alarm monitoring company near me",
  "alarm system installers near me",
  "alarm repair near me",
  "alarm company near me Houston TX",
  "local alarm company near me",
  "same day security camera installation Houston",
  "emergency alarm service Houston",
];
...
const SEARCH_INTENT_CLUSTERS = [
  ...
  },
  {
    ...
    terms: [
      ...
      "alarm company near me",
      "alarm companies near me Houston",
      "alarm installers near me",
      "alarm repair near me",
      "alarm system not working",
      "same day alarm installation Houston",
    ],
  },
  {
    ...
    terms: [
      ...
      "home security systems near me",
      "home security company near me",
      "home alarm installation near me",
    ],
  },
  {
  ...
  },
  {
    ...
    terms: [
      "24/7 alarm monitoring Houston",
      "alarm monitoring company Houston",
      "professional alarm monitoring Houston",
      "alarm monitoring near me",
      "24 hour alarm monitoring near me",
      "alarm monitoring company near me",
    ],
  },
    ...
    "review": [
      {
        ...
        "reviewBody": "Texas Total Security installed our complete home security system. Professional installation, great equipment, and the professional monitoring gives us real peace of mind."
      },
      {
        "@type": "Review",
        "reviewRating": {
  ...
  const base: Record<string, unknown> = {
    ...
    "hasOfferCatalog": {
      ...
      "itemListElement": [
        ...
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "24/7 Professional Monitoring" } },
        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Absolutely. We specialize in hardwired alarm systems and have extensive experience installing in older homes — routing wiring discreetly through finished walls, attic spaces, and existing conduit. Our licensed technicians work around your walls, trim, and infrastructure with zero damage."
            }
          },
          {
            "@type": "Question",
          ...
          },
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "We are locally owned and operated — not a franchise. We provide professional 24/7 monitoring through a certified San Antonio partner center, and your account is managed by Texas Total Security."
            }
          },
          {
            "@type": "Question",
  ...
  return [
    {
      ...
      "description": "Custom residential hardwired alarm system installation for Houston homeowners. Professional design, local installation, smart home integration, and 24/7 professional monitoring.",
      "provider": provider,
      "areaServed": areaServed,
      "offers": [freeOffer, { "@type": "Offer", "name": "Professional Alarm Installation" }, { "@type": "Offer", "name": "24/7 Professional Monitoring" }],
    },
    {
      "@context": "https://schema.org",
      "@type": "Service",
      ...
      "description": "Enterprise-grade commercial alarm systems for Houston businesses, offices, retail, and industrial facilities. Licensed installation, professional monitoring, and system takeovers from any provider.",
      "provider": provider,
      "areaServed": areaServed,
    ...
    },
    {
      ...
      "provider": provider,
      "areaServed": areaServed,
      "offers": [{ "@type": "Offer", "name": "24/7 Professional Monitoring", "priceCurrency": "USD" }, { "@type": "Offer", "name": "Video Verification Monitoring" }],
    },
    {
      "@context": "https://schema.org",
      "@type": "Service",
      ...
      "description": "Cameras with built-in sirens, strobes, and two-way audio for real-time intruder deterrence. Backed by 24/7 professional monitoring with instant local dispatch response.",
      "provider": provider,
      "areaServed": areaServed,
