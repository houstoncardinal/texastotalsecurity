...
export const cities: CityData[] = [
  {
    ...
    services: ["alarm system installation", "hard-wired security camera installation", "24/7 alarm monitoring", "commercial security", "residential security", "HOA gate cameras", "license plate reader", "active deterrence systems"],
    faqs: [
      { question: "What security system is best for a Houston inner-loop home?", answer: "For Houston's affluent inner-loop homes, we recommend a layered system: a professionally monitored alarm, hard-wired 4K cameras covering all entry points and driveways, and license plate reader at the driveway. Texas Total Security provides a free onsite assessment to design a system custom to your property." },
  ...
  },
  {
    ...
    services: ["estate alarm systems", "hard-wired 4K camera installation", "driveway license plate reader", "24/7 alarm monitoring", "smart home integration", "security consultation"],
    faqs: [
      ...
      { question: "What security cameras work best for large wooded Village estates?", answer: "For large wooded lots in the Villages, we recommend hard-wired 4K cameras at all entry points, PTZ cameras covering open areas, driveway license plate reader, and perimeter cameras positioned to see through foliage. All cameras are weatherproof and designed for reliable long-term operation." },
  ...
  },
  {
    ...
    securityContext: "The Galleria corridor's density and high vehicle traffic create elevated exposure to residential and vehicle-related crime. High-rise condo residents face unique entry, lobby, and parking garage security needs, while Tanglewood estate owners benefit most from hard-wired perimeter systems and License Plate Reader (LPR) at driveways. Commercial properties require enterprise-grade integrated systems.",
    neighborhoods: ["Tanglewood", "Briargrove", "Galleria High-rises", "Post Oak", "Afton Oaks adjacent"],
    services: ["luxury residential security", "hard-wired camera systems", "high-rise condo security consultation", "commercial security", "alarm monitoring", "License Plate Reader (LPR) driveway cameras"],
    faqs: [
      ...
      { question: "What security is best for Tanglewood estates?", answer: "Tanglewood estates benefit from hard-wired 4K perimeter cameras, driveway License Plate Reader (LPR), a monitored alarm, and smart home integration. We design every system during a free onsite assessment." },
    ],
  ...
  },
  {
    ...
    securityContext: "The Energy Corridor's mix of corporate headquarters, office parks, and upscale residential communities creates a diverse security landscape. Commercial facilities require monitored alarms, hard-wired security cameras, and professionally monitored perimeter systems. Residential communities along the I-10 feeder roads benefit from hard-wired cameras and professional alarm monitoring.",
    neighborhoods: ["Energy Corridor residential", "Barker Reservoir adjacent", "Memorial Bend", "Briar Forest"],
    services: ["commercial alarm & camera systems", "residential security", "hard-wired camera installation", "License Plate Reader (LPR) cameras", "24/7 monitoring", "multi-site commercial security"],
    faqs: [
      { question: "Do you install security systems in the Energy Corridor (77079)?", answer: "Yes. We serve both commercial and residential properties throughout the Energy Corridor and surrounding 77079 zip code — alarm systems, hard-wired cameras, License Plate Reader (LPR) cameras, and 24/7 professional monitoring." },
      { question: "What commercial security services do you offer in the Energy Corridor?", answer: "We design complete commercial security systems for Energy Corridor office buildings, corporate campuses, and retail centers — including monitored alarm systems, 4K IP cameras, License Plate Reader (LPR) cameras, and active deterrence." },
  ...
  },
  {
    ...
    services: ["premium residential alarm systems", "hard-wired camera installation", "driveway License Plate Reader (LPR) cameras", "24/7 alarm monitoring", "smart home integration", "estate security"],
    faqs: [
  ...
  },
  {
    ...
    securityContext: "River Oaks estate homes face unique security challenges: large perimeters, mature screening landscaping that creates blind spots, motorized gates, and trophy vehicles in exposed driveways. Hard-wired 4K cameras, driveway license plate reader, professionally monitored alarms, and smart integration with motorized gate systems are the security standard for River Oaks properties.",
    neighborhoods: ["River Oaks Boulevard estates", "Afton Oaks", "Avalon Place", "Huntingdon Place", "Elm Grove", "Neartown adjacent"],
    services: ["estate security systems", "hard-wired 4K camera installation", "driveway License Plate Reader (LPR) cameras", "gate access integration", "24/7 alarm monitoring", "smart home integration"],
    faqs: [
      ...
      { question: "Can you integrate security cameras with motorized gate systems in River Oaks?", answer: "Absolutely. We design integrated systems combining hard-wired perimeter cameras, driveway License Plate Reader (LPR), alarm monitoring, and communication with motorized gate controllers — all managed from a single platform." },
    ...
    metaDescription: "Estate security for River Oaks Houston (77027 / 77019). Hard-wired cameras, License Plate Reader (LPR), gate integration & 24/7 monitoring. Locally owned, highly rated. Call (713) 387-9937.",
  },
  {
    ...
    securityContext: "Spring Valley's mature tree canopy and large lot sizes create the same camera placement challenges found in the Memorial Villages. Hard-wired systems are strongly preferred for reliability and aesthetics. The neighborhood's single-entry street layout makes driveway License Plate Reader (LPR) cameras particularly effective.",
    neighborhoods: ["Spring Valley Village", "Spring Branch adjacent", "Westview adjacent"],
    services: ["residential alarm systems", "hard-wired camera installation", "driveway License Plate Reader (LPR) cameras", "24/7 alarm monitoring", "smart home integration"],
    faqs: [
  ...
  },
  {
    ...
    securityContext: "Upper Kirby's mix of luxury multifamily, commercial, and residential properties requires versatile security expertise. Apartment complexes benefit from hard-wired camera systems with License Plate Reader (LPR) at parking entrances; retail properties need commercial-grade monitored alarm systems; and single-family homeowners require discreet residential cameras with professional monitoring.",
