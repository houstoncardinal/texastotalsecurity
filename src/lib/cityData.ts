...
export const cities: CityData[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "What kind of security systems do you recommend for Spring businesses?", answer: "For Spring commercial properties, we design layered systems combining monitored alarm systems, commercial-grade IP cameras, access control, and active deterrence — custom-engineered for your specific facility and operating hours." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "What commercial security services do you offer in Rosenberg?", answer: "We design and install complete commercial security systems for Rosenberg businesses — including monitored alarm systems, commercial IP cameras, active deterrence, and access control. Every system is custom-designed for your facility during a free onsite assessment." },
      { question: "How far is your monitoring center from Rosenberg?", answer: "Our Houston monitoring center is approximately 30 miles from Rosenberg. Our local operators monitor your system 24/7 and dispatch Fort Bend County authorities immediately upon alarm verification — with no reliance on national outsourced monitoring companies." },
    ],
