...
export const cities: CityData[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "What is the response time for monitoring in Pearland?", answer: "We provide professional 24/7 alarm monitoring with fast response times. When an alarm triggers, trained operators verify and dispatch Pearland or Brazoria County authorities within seconds." },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "Do you offer 24/7 monitoring for Rosenberg properties?", answer: "Yes. We provide professional 24/7 alarm monitoring for Rosenberg homes and businesses. Trained operators monitor your system around the clock and dispatch Fort Bend County authorities immediately upon alarm verification." },
    ],
