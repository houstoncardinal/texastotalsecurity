...
export const cities: CityData[] = [
  {
    ...
    services: ["alarm system installation", "hard-wired security camera installation", "24/7 alarm monitoring", "commercial security", "residential security", "HOA gate cameras", "license plate reader (HOA & commercial)", "active deterrence systems"],
    faqs: [
      { question: "What security system is best for a Houston inner-loop home?", answer: "For Houston's affluent inner-loop homes, we recommend a layered system: a professionally monitored alarm and hard-wired 4K cameras covering all entry points and driveways. Texas Total Security provides a free onsite assessment to design a system custom to your property." },
  ...
  },
  {
    ...
    services: ["estate alarm systems", "hard-wired 4K camera installation", "24/7 alarm monitoring", "smart home integration", "security consultation"],
    faqs: [
      ...
      { question: "What security cameras work best for large wooded Village estates?", answer: "For large wooded lots in the Villages, we recommend hard-wired 4K cameras at all entry points, PTZ cameras covering open areas, and perimeter cameras positioned to see through foliage. All cameras are weatherproof and designed for reliable long-term operation." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "What security is best for Tanglewood estates?", answer: "Tanglewood estates benefit from hard-wired 4K perimeter cameras, a monitored alarm, and smart home integration. We design every system during a free onsite assessment." },
    ],
  ...
  },
  {
    ...
    services: ["premium residential alarm systems", "hard-wired camera installation", "24/7 alarm monitoring", "smart home integration", "estate security"],
    faqs: [
  ...
  },
  {
    ...
    services: ["estate security systems", "hard-wired 4K camera installation", "gate access integration", "24/7 alarm monitoring", "smart home integration"],
    faqs: [
      ...
      { question: "Can you integrate security cameras with motorized gate systems in River Oaks?", answer: "Absolutely. We design integrated systems combining hard-wired perimeter cameras, alarm monitoring, and communication with motorized gate controllers — all managed from a single platform." },
    ...
    metaDescription: "Estate security for River Oaks Houston (77027 / 77019). Hard-wired cameras, gate integration & 24/7 monitoring. Locally owned, highly rated. Call (713) 387-9937.",
  },
  {
    ...
    securityContext: "Spring Valley's mature tree canopy and large lot sizes create the same camera placement challenges found in the Memorial Villages. Hard-wired systems are strongly preferred for reliability and aesthetics, especially given the neighborhood's single-entry street layout.",
    neighborhoods: ["Spring Valley Village", "Spring Branch adjacent", "Westview adjacent"],
    services: ["residential alarm systems", "hard-wired camera installation", "24/7 alarm monitoring", "smart home integration"],
    faqs: [
      ...
      { question: "What security systems work best for Spring Valley properties?", answer: "For Spring Valley's larger lots with mature trees, hard-wired 4K cameras at entry points and a monitored alarm provide comprehensive, reliable protection. We design every system during a free onsite evaluation." },
    ],
