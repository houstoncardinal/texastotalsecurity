...
export const cities: CityData[] = [
  ...
  },
  {
    ...
    county: "Harris County",
    population: "153,000+",
    intro: "Pasadena is one of the largest cities in Harris County and a critical industrial and residential hub east of Houston. Home to a large petrochemical workforce, diverse residential neighborhoods, and significant commercial activity, Pasadena property owners face security challenges that demand professional, locally designed systems.",
    securityContext: "Pasadena's blend of industrial facilities, small businesses, and dense residential neighborhoods creates a multifaceted security environment. Property crime rates in parts of Pasadena remain above the regional average, making professionally monitored alarm systems and high-resolution surveillance cameras among the most effective deterrents available.",
    neighborhoods: ["South Pasadena", "North Pasadena", "Deepwater", "Strawberry Park", "Redwood Forest", "Shaver", "Genoa Red Bluff"],
    services: ["alarm system installation", "commercial security cameras", "industrial facility security", "residential security", "alarm monitoring", "active deterrence systems", "system takeovers"],
    faqs: [
      { question: "Does Texas Total Security serve Pasadena, TX?", answer: "Yes. We provide full alarm, camera, and monitoring services throughout Pasadena and eastern Harris County. Our technicians are familiar with Pasadena's diverse mix of residential, commercial, and industrial properties." },
      { question: "Can you install security for commercial properties and warehouses in Pasadena?", answer: "Absolutely. We design commercial and industrial security systems for Pasadena's business community — including warehouses, distribution facilities, retail locations, and mixed-use properties. Every system is custom-designed for your specific facility layout and risk profile." },
      { question: "Can you take over an existing alarm system in Pasadena?", answer: "In most cases, yes. We evaluate your existing panels and sensors from ADT, Brinks, Vivint, or any other provider during a free assessment. If the equipment is compatible, we take it over and connect it to our Houston monitoring center — saving you significant replacement costs." },
    ],
    metaTitle: "Pasadena TX Security Systems | Alarm & Camera Installation | Texas Total Security",
    metaDescription: "Security systems for Pasadena, TX. Professional alarm installation, commercial cameras & 24/7 local monitoring for homes and businesses in Pasadena. Call (713) 387-9937.",
  },
  {
    slug: "tomball",
    name: "Tomball",
  ...
  },
  {
    ...
    name: "Humble",
    county: "Harris County",
    population: "16,000+ (city), 90,000+ (area)",
    intro: "Humble is a fast-growing northeastern Houston community anchored by proximity to George Bush Intercontinental Airport, major retail corridors along FM 1960 and Highway 59, and a booming residential market. From established neighborhoods near Deerbrook Mall to newer subdivisions pushing toward Kingwood and Atascocita, Humble property owners need security they can rely on.",
    securityContext: "Humble's location near major transportation corridors — including I-69/US 59 and Beltway 8 — gives it both economic vitality and elevated property crime exposure. Vehicle theft, package theft, and residential burglary are among the most common concerns reported by Humble homeowners, all of which are directly addressed by professional alarm and surveillance systems.",
    neighborhoods: ["Atascocita", "Summerwood", "Fall Creek", "Deerbrook area", "Walden on Lake Houston", "Lakeshore", "Eagle Springs"],
    services: ["alarm system installation", "security cameras", "residential security", "smart home integration", "alarm monitoring", "commercial security", "system takeovers"],
    faqs: [
      { question: "Does Texas Total Security serve Humble and Atascocita?", answer: "Yes. We provide professional alarm, camera, and 24/7 monitoring services throughout Humble, Atascocita, and the surrounding communities in northeastern Harris County — including Fall Creek, Summerwood, and Lake Houston area neighborhoods." },
      { question: "What security cameras are recommended for Humble homes?", answer: "For Humble and Atascocita homes, we recommend 4K perimeter cameras with night vision, video doorbell systems for package theft prevention, and license plate recognition cameras for driveway monitoring. Every system is designed during a free onsite assessment." },
      { question: "Can you take over an existing alarm system in Humble?", answer: "In most cases, yes. We evaluate your existing alarm equipment during a free property visit. If it's compatible — like Honeywell VISTA, DMP, or DSC panels — we connect it to our Houston monitoring center, saving you the cost of a full replacement." },
    ],
    metaTitle: "Humble TX Security Systems | Alarm & Camera Installation | Texas Total Security",
    metaDescription: "Security systems for Humble, TX & Atascocita. Alarm installation, security cameras & 24/7 local monitoring for Fall Creek, Summerwood & surrounding communities. Call (713) 387-9937.",
  },
  {
    slug: "spring",
    name: "Spring",
