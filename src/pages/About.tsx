...
const googleReviews = [
  ...
  { name: "Jason Hammond", role: "Google Review", text: "FANTASTIC experience and very professional and caring company. I felt very comfortable from start to finish. Honest and knowledgeable staff." },
  ...
  { name: "DLA Armstrong", role: "Google Review", text: "I was surprised by the laid back style by phone, AND above and beyond EXTRA SERVICE I RECEIVED from TTS. They were detailed, educated me on security tips and reviewed with me until I understood everything before they left." },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>Texas Total Security is the leading expert in security system installation in the Houston area. Specializing in commercial and residential installations, we guarantee that we will keep your business and home secured to keep them safe for your family and your profits.</p>
                <p>Every system we provide is backed by professional alarm system installation, ensuring your equipment performs at its best from day one. The Texas Total Security team understands what local properties require — strong coverage, smart integration, and dependable monitoring.</p>
                <p>We take pride in delivering responsive service and long-term support, helping you stay protected around the clock with solutions built for real-world challenges.</p>
              </div>
            </div>
            <div className="glass-card-static rounded-2xl p-8 sm:p-10">
              ...
              <div className="grid grid-cols-2 gap-8">
                {[
                  ...
                  <div key={stat.label}>
                    <p className="stat-number mb-1">{stat.num}</p>
