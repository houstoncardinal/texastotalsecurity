...
const projects = [
  ...
  },
  {
    ...
    solution: "Installed a complete alarm system with 12 cameras, smart lock integration, environmental sensors, and local 24/7 monitoring.",
    systems: ["Alarm System", "Security Cameras", "Smart Locks", "Environmental Sensors", "24/7 Monitoring"],
