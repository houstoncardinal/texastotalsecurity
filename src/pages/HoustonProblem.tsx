...
const solutions = [
  ...
  },
  {
    ...
    desc: "Whole-home protection tailored to your neighborhood. Sensors, cameras, smart integration, and 24/7 professional monitoring.",
    href: "/residential",
  },
  {
    icon: Building2,
...
const HoustonProblem = () => (
  <Layout>
    <SEOHead
      ...
      description="Houston's property crime, burglary, and vehicle theft rates are rising. Texas Total Security is Houston's #1 local alarm company — alarm systems, security cameras, HOA surveillance & 24/7 professional monitoring. Call (713) 387-9937."
      schemas={schemas}
    />
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-28 lg:py-36">
        ...
        >
          Property crime, vehicle theft, and home burglaries are real threats in the Greater Houston area. Most are preventable. Texas Total Security protects Houston homes, businesses, and communities — with the alarm systems, security cameras, and 24/7 professional monitoring that actually work.
        </motion.p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          >
            ...
            >
              ...
              {/* Rows */}
              {[
                ["Monitoring Center", "Certified San Antonio Partner", "National Call Center"],
                ...
                ["Account Ownership", "Managed by TTS", "Often Sold to Third Party"],
